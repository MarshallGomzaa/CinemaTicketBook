		...
		<div class="content-top">
			<div class="section group">
				<div class="about span_1_of_2">
					...
					<!-- <form action="seat.php?movie_id=<?= $movie['movie_id'] ?>" method="POST"> -->
					...
					<table class="table table-hover table-bordered text-center">
						...
						<tr>
							<td colspan="2">
								<a href="seat.php?movie_id=<?= $movie['movie_id'] ?>"><button class="btn btn-info" style="width:100%"> Book Now</button></a>
							</td>
						</tr>
					</table>
					<!-- </form> -->
